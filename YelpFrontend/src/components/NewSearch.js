				...
				<div className="relative h-full min-h-screen pb-40 bg-gray-100">
					<div className="py-4 px-7">
						<div className="mt-7  rounded-[4px]  bg-white max-w-[1124px] w-full mx-auto ">
							<div className="flex flex-wrap justify-between pb-2 lg:flex-nowrap">
								<div className="flex flex-col w-full gap-4 lg:flex-row md:flex-col p-7">
									...
									<button className="bg-indigo-700  text-white lg:max-w-[164px] font-medium px-6 py-4 w-full  rounded-[4px] leading-[14px] hover:bg-indigo-600"
										id="searchButton"
										onClick={() => props.onSearchAction(searchContent)}>Search</button>
								</div>
								<button onClick={showOptions} className="text-indigo-700 hover:text-indigo-800 w-full lg:max-w-[200px] flex justify-end items-center gap-3  font-medium pr-7">
							...
							<div className="hidden pb-10 mt-12 px-7" id="interaction">
								<div className="flex flex-wrap justify-between lg:flex-nowrap">
									<div className="flex flex-wrap w-full gap-4 ">
										<div className="relative lg:max-w-[410px] w-full">
											<input placeholder="Search" className="p-4 py-3 outline-none focus pr-10  bg-gray-100 border rounded border-gray-100 text-slate-600  lg:max-w-[410px] w-full leading-4" />
											<svg className="absolute pointer-events-none top-3 right-5" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M10 17C13.866 17 17 13.866 17 10C17 6.13401 13.866 3 10 3C6.13401 3 3 6.13401 3 10C3 13.866 6.13401 17 10 17Z" stroke="#4B5563" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
												<path d="M21 21L15 15" stroke="#4B5563" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
											</svg>
										</div>
										<button className="bg-indigo-700  text-white lg:max-w-[164px] font-medium px-6 py-4 w-full  rounded-[4px] leading-[14px] hover:bg-indigo-600">Search</button>
									</div>
									<button className="text-indigo-700 hover:text-indigo-800 w-full lg:max-w-[200px] flex justify-end items-center gap-3 lg:mt-0 md:mt-4 mt-4 font-medium">
										Advanced Search <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path fillRule="evenodd" clipRule="evenodd" d="M2.96967 7.84467C3.26256 7.55178 3.73744 7.55178 4.03033 7.84467L8 11.8143L11.9697 7.84467C12.2626 7.55178 12.7374 7.55178 13.0303 7.84467C13.3232 8.13756 13.3232 8.61244 13.0303 8.90533L8.53033 13.4053C8.23744 13.6982 7.76256 13.6982 7.46967 13.4053L2.96967 8.90533C2.67678 8.61244 2.67678 8.13756 2.96967 7.84467Z" fill="#4338CA" />
											<path fillRule="evenodd" clipRule="evenodd" d="M8 2.375C8.41421 2.375 8.75 2.71079 8.75 3.125V12.25C8.75 12.6642 8.41421 13 8 13C7.58579 13 7.25 12.6642 7.25 12.25V3.125C7.25 2.71079 7.58579 2.375 8 2.375Z" fill="#4338CA" />
										</svg>
									</button>
								</div>
								...
								<div className="grid gap-10 mt-12 md:grid-cols-1 lg:grid-cols-2">
									<div>
										...
										<div className="flex items-center justify-start ">
											<input className="relative w-full h-12 px-4 py-3 text-sm leading-none text-left text-gray-600 border border-gray-300 rounded outline-none" type="text" placeholder="For example “Alpha”" />
										</div>
									</div>
									<div>
								...
								<div className="flex flex-col items-center justify-end w-full gap-4 mt-10 lg:flex-row">
									<button className="bg-white  text-indigo-700 lg:max-w-[164px] font-medium px-6 py-4 w-full border border-indigo-700  rounded-[4px] leading-[14px] hover:bg-gray-50">Cancel</button>
									<button className="bg-indigo-700  text-white lg:max-w-[164px] font-medium px-6 py-4 w-full  rounded-[4px] leading-[14px] hover:bg-indigo-600">Search</button>
								</div>
							</div>
						</div>
