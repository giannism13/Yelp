...
const Business = () => {
  ...
  const imageInput = useMemo(
    () =>
      images.map((image) => ({
        original: `${API_URL}/images/${image.photo_id}.jpg`,
      })),
    [images]
  );
    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
      <div className="flex justify-center lg:flex-row flex-col gap-8">
        ...
        <div className="flex flex-col  w-full sm:w-96 md:w-8/12 lg:w-6/12">
          ...
          <h3 className="lg:text-xl lg:leading-9 leading-7 text-gray-500">
            ...
            <div className=" flex flex-row justify-between items-center mt-2">
              <ul className="font-medium text-base leading-4 text-gray-600">
                <li>
                  {" "}
                  <b>Monday:</b>{" "}
                  {businessData.Monday ? businessData.Monday + " " : "Closed"}{" "}
                </li>
                <li>
                  {" "}
                  <b>Tuesday:</b>{" "}
                  {businessData.Tuesday ? businessData.Tuesday + " " : "Closed"}{" "}
                </li>
                <li>
                  {" "}
                  <b>Wednesday:</b>{" "}
                ...
                <li>
                  {" "}
                  <b>Friday:</b>{" "}
                  {businessData.Friday ? businessData.Friday + " " : "Closed"}{" "}
                </li>
                <li>
                  {" "}
                  <b>Saturday:</b>{" "}
                ...
                <li>
                  {" "}
                  <b>Sunday:</b>{" "}
                  {businessData.Sunday ? businessData.Sunday + " " : "Closed"}{" "}
                </li>
              </ul>
            </div>
            <hr className=" bg-gray-200 w-full mt-4" />
            <p className="font-medium text-base leading-3 text-black mt-8">
              {businessData.address}, {businessData.postal_code},{" "}
              {businessData.city}, {businessData.state}
            </p>
          </div>

          <div className="w-full h-full mt-1 pb-2">
            {businessData.latitude && <Map data={[businessData]}></Map>}
          </div>
        </div>
